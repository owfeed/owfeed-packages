...
**How owfeed gets here.** `owfeed/owfeed/setup@v0.5.2`, pinned to a release. In `pr.yml` and
`publish.yml` the pin is the `uses: .../feed.yml@v0.5.2` line alone: that workflow installs the
